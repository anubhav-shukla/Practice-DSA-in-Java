...
public class rearrangearrayinalternatingpositivenegativeitemswithextraspac {
...
{
	rearrangearrayinalternatingpositivenegativeitemswithextraspac rearrange = new rearrangearrayinalternatingpositivenegativeitemswithextraspac();
/* int arr[n] = {-5, 3, 4, 5, -6,
                 -2, 8, 9, -1, -4};
int arr[] = {-5, -3, -4, -5, -6,
             2 , 8, 9, 1 , 4};
